...
public:
    VMem(int pagenums=16,int tlbnums=256,int framenums=256,int pagesize=256,int framesize=256,const std::string& filename="D:\\MY_CODE\\CPP\\OS\\file\\VMem.bin",Tran tran=impltran);
    ~VMem();
    void status();
    void reset();
